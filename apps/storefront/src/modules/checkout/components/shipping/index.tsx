...
/** Pickup = fulfillment set type "pickup", or option type code/label from restaurant seed. */
function isPickupShippingOption(option: ShippingOptionWithFulfillment) {
...
const Shipping: React.FC<ShippingProps> = ({
  ...
  const _shippingMethods = availableShippingMethods?.filter(
    (sm) => !isPickupShippingOption(sm as ShippingOptionWithFulfillment)
  )

  const _pickupMethods = availableShippingMethods?.filter((sm) =>
    isPickupShippingOption(sm as ShippingOptionWithFulfillment)
  )
